class USB2p0_FS_bulk_in_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_FS_bulk_in_test)
     
    usb2p0_fs_ct_get_descriptor_vsequence          fs_get_descri_vseq;
    usb2p0_fs_ct_set_configuration_vsequence       fs_set_config_vseq; 
    usb2p0_fs_bulk_in_vsequence                    fs_bulk_vseq;

    function new(string name="USB2p0_FS_bulk_in_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
        ...
        fs_bulk_vseq = usb2p0_fs_bulk_in_vsequence::type_id::create("fs_bulk_vseq"); 	
        fs_get_descri_vseq = usb2p0_fs_ct_get_descriptor_vsequence::type_id::create("fs_get_descri_vseq"); 	
    endfunction
  

   task run_phase(uvm_phase phase);
     `uvm_info("FS_BULK_TRANSFER_TEST","ENTERED_USB2p0_FS_BULK_IN",UVM_LOW)
     ...
     `uvm_info("FS_BULK_TRANSFER_TEST","COMPLETED_USB2p0_FS_BULK_IN",UVM_LOW)
  endtask
