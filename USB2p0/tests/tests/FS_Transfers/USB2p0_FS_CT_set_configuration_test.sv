class USB2p0_FS_CT_set_configuration_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_FS_CT_set_configuration_test)
 
    usb2p0_fs_ct_set_configuration_vsequence         fs_set_config_vseq; 
  
    function new(string name="USB2p0_FS_CT_set_configuration_test",uvm_component parent);
