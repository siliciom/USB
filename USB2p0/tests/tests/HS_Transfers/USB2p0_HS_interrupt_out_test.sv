class USB2p0_HS_interrupt_out_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_HS_interrupt_out_test)
     
    usb2p0_hs_ct_get_descriptor_vsequence            hs_get_descri_vseq;
    usb2p0_hs_ct_set_configuration_vsequence         hs_set_config_vseq; 
    usb2p0_hs_interrupt_out_vsequence                 hs_interrupt_vseq;

    function new(string name="USB2p0_HS_interrupt_out_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
        ...
        hs_interrupt_vseq = usb2p0_hs_interrupt_out_vsequence::type_id::create("hs_interrupt_vseq"); 	
        hs_get_descri_vseq = usb2p0_hs_ct_get_descriptor_vsequence::type_id::create("hs_get_descri_vseq"); 	
    endfunction
  

   task run_phase(uvm_phase phase);
     `uvm_info("HS_INTERRUPT_TRANSFER_TEST","ENTERED_USB2p0_HS_INTERRUPT_OUT",UVM_LOW)
     ...
     `uvm_info("HS_INTERRUPT_TRANSFER_TEST","COMPLETED_USB2p0_HS_INTERRUPT_OUT",UVM_LOW)
  endtask
