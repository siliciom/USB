class usb2p0_ls_ct_ep1_set_configuration_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_ep1_set_configuration_vsequence)
    ...
    //usb2p0_host_ls_ct_set_configuration_in_sequence  status_in_token_seq;
    usb2p0_host_ls_ct_ep1_set_configuration_sequence  set_config_ep1_seq;

  function new (string name = "usb2p0_ls_ct_ep1_set_configuration_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_ep1_set_configuration_vsequence::body();
    ...
    //status_in_token_seq=usb2p0_host_ls_ct_set_configuration_in_sequence::type_id::create("status_in_token_seq");
    set_config_ep1_seq=usb2p0_host_ls_ct_ep1_set_configuration_sequence::type_id::create("set_config_ep1_seq");
...
//
      fork 
	//status_in_token_seq.start(p_sequencer.host_seqr);
	set_config_ep1_seq.start(p_sequencer.host_seqr);
	phy_ls_det.start(p_sequencer.phy_seqr);
	device_ls_det.start(p_sequencer.device_seqr); 
	device_handshake_send.start(p_sequencer.device_seqr); 
     join 
