class usb2p0_hs_ct_get_descriptor_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_hs_ct_get_descriptor_vsequence)
    ...
    usb2p0_host_hs_ct_get_descriptor_sequence        get_descrip_seq;
 
  function new (string name = "usb2p0_hs_ct_get_descriptor_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_hs_ct_get_descriptor_vsequence::body();

     `uvm_info("HS_CONTROL_TRANSFER_VSEQ","ENTERED_INTO_HS_CONTROL_TRANSFER_GET_DESCRIP_VSEQ ",UVM_LOW)
       ...
       get_descrip_seq=usb2p0_host_hs_ct_get_descriptor_sequence::type_id::create("get_descrip_seq");
//     fork 
...
//
      fork 
	    ...
	    device_handshake_send.start(p_sequencer.device_seqr); 
     join
     `uvm_info("HS_CONTROL_TRANSFER_VSEQ","COMPLETED_INTO_HS_CONTROL_TRANSFER_GET_DESCRIP_VSEQ ",UVM_LOW)
endtask
