class usb2p0_fs_ct_get_configuration_error_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_ct_get_configuration_error_vsequence)
    ...
    usb2p0_host_fs_ct_get_configuration_error_sequence      get_config_fs_seq;

  function new (string name = "usb2p0_fs_ct_get_configuration_error_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_ct_get_configuration_error_vsequence::body();
     ...
     `uvm_info("LS_CONTROL_TRANSFER_VSEQ","ENTERED_INTO_LS_CONTROL_TRANSFER_GET_CONFIGURATION_ERROR_VSEQ ",UVM_LOW)
        ...
        get_config_fs_seq=usb2p0_host_fs_ct_get_configuration_error_sequence::type_id::create("get_config_fs_seq");

      fork 
	get_config_fs_seq.start(p_sequencer.host_seqr);
