class usb2p0_fs_random_interrupt_out_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_random_interrupt_out_vsequence)
    ...
    usb2p0_host_fs_interrupt_random_out_sequence     random_seq;

  function new (string name = "usb2p0_fs_random_interrupt_out_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_random_interrupt_out_vsequence::body();
    ...
    random_seq=usb2p0_host_fs_interrupt_random_out_sequence::type_id::create("random_seq");
