class usb2p0_fs_random_isochronous_in_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_random_isochronous_in_vsequence)
  ...
  function new (string name = "usb2p0_fs_random_isochronous_in_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_random_isochronous_in_vsequence::body();
