class usb2p0_fs_interrupt_in_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_interrupt_in_vsequence)
     ...
     usb2p0_host_fs_interrupt_in_sequence           interrupt_in_seq;

  function new (string name = "usb2p0_fs_interrupt_in_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_interrupt_in_vsequence::body();
    ...
    interrupt_in_seq=usb2p0_host_fs_interrupt_in_sequence::type_id::create("interrupt_in_seq");
