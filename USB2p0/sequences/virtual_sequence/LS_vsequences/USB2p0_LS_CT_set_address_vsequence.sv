class usb2p0_ls_ct_set_address_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_set_address_vsequence)
   ...
   // USB2p0_phy_LS_data_stage_sequence         phy_data_stage_seq;
    ...
    usb2p0_host_ls_ct_set_address_in_sequence  status_in_token_seq;

  function new (string name = "usb2p0_ls_ct_set_address_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_set_address_vsequence::body();
   ...
   // phy_data_stage_seq=USB2p0_phy_LS_data_stage_sequence::type_id::create("phy_data_stage_seq");
    ...
    status_in_token_seq=usb2p0_host_ls_ct_set_address_in_sequence::type_id::create("status_in_token_seq");
