class usb2p0_host_HS_detect_sequence extends uvm_sequence #(USB2p0_sequence_item);
  	
      `uvm_object_utils(usb2p0_host_HS_detect_sequence)

       USB2p0_sequence_item usb_host_seq_item;

       function new(string name="usb2p0_host_HS_detect_sequence");
             super.new(name);
        endfunction
