class usb2p0_host_ls_ct_ep1_set_configuration_sequence extends USB2p0_HOST_sequence;
  
	`uvm_object_utils(usb2p0_host_ls_ct_ep1_set_configuration_sequence)
  	USB2p0_sequence_item req;

       function new(string name="usb2p0_host_ls_ct_ep1_set_configuration_sequence");
            super.new(name);
       endfunction
    ...
    task body();
	    ...
	    if(!req.randomize() with {
                                  ...
                                  bmRequestType    ==  8'd0;
                                  bRequest         ==  8'd9; 
                                  wValue           ==  16'h0001;//0000_0000_0000_0001 
   	                              wIndex 	       ==  16'd0;  
                                  wLength          ==  16'd0;     
