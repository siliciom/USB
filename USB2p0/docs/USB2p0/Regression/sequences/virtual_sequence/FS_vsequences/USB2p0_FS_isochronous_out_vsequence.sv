class usb2p0_fs_isochronous_out_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_isochronous_out_vsequence)
     ...
     usb2p0_host_fs_isochronous_out_sequence         iso_in_seq;

  function new (string name = "usb2p0_fs_isochronous_out_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_isochronous_out_vsequence::body();

   `uvm_info("FS_ISO_TRANSFER_VSEQ","ENTERED_INTO_ISOCHRONOUS_OUT_VSEQ ",UVM_LOW)
   // phy_data_stage_seq=USB2p0_phy_LS_data_stage_sequence::type_id::create("phy_data_stage_seq");
    ...
    iso_in_seq=usb2p0_host_fs_isochronous_out_sequence::type_id::create("iso_in_seq");
...
//
	  ...
	  device_handshake_send.start(p_sequencer.device_seqr); 
     join 
     `uvm_info("FS_ISO_TRANSFER_VSEQ","COMPLETED_INTO_ISOCHRONOUS_OUT_TRANSFER_VSEQ ",UVM_LOW)
endtask
