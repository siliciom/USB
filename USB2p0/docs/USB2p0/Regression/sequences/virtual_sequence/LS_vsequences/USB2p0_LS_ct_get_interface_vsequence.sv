class usb2p0_ls_ct_get_interface_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_get_interface_vsequence)
    ...
    usb2p0_host_ls_ct_get_interface_sequence         get_interface_seq;
   //usb2p0_host_ls_ct_set_configuration_in_sequence  set_config_seq;

  function new (string name = "usb2p0_ls_ct_get_interface_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_get_interface_vsequence::body();
     ...
     // phy_data_stage_seq=USB2p0_phy_LS_data_stage_sequence::type_id::create("phy_data_stage_seq");
      ...
      get_interface_seq=usb2p0_host_ls_ct_get_interface_sequence::type_id::create("get_interface_seq");
