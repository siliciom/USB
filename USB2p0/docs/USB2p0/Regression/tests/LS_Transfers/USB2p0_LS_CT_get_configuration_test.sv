class USB2p0_LS_CT_get_configuration_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_LS_CT_get_configuration_test)
 
    usb2p0_ls_ct_get_configuration_vsequence         ls_get_config_vseq; 
    usb2p0_ls_ct_set_configuration_vsequence         ls_set_config_vseq;
    
    function new(string name="USB2p0_LS_CT_get_configuration_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
   	...
   	uvm_config_db#(speed_state)::set(null, "*", "USB_SPEED",usb_speed);
        ls_get_config_vseq = usb2p0_ls_ct_get_configuration_vsequence::type_id::create("ls_get_config_vseq"); 	
