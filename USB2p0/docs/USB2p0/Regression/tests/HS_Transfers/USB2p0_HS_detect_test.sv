class USB2p0_HS_detect_test extends USB2p0_base_test;
    ...
    `uvm_component_utils(USB2p0_HS_detect_test)
     ...
     function void build_phase(uvm_phase phase);
         ...
         usb_speed = USB_HS;
         host_hs_det=usb2p0_host_HS_detect_sequence::type_id::create("host_hs_det",this);
         phy_hs_det=USB2p0_phy_HS_detect_sequence::type_id::create("phy_hs_det",this);
         device_hs_det=USB2p0_DEVICE_HS_detect_sequence::type_id::create("device_hs_det",this);
