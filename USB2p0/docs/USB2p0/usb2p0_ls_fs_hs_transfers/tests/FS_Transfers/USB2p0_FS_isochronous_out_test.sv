class USB2p0_FS_isochronous_out_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_FS_isochronous_out_test)
     
    usb2p0_fs_ct_get_descriptor_vsequence            fs_get_descri_vseq;
    usb2p0_fs_ct_set_configuration_vsequence         fs_set_config_vseq; 
    usb2p0_fs_isochronous_out_vsequence               fs_iso_vseq;
    //usb2p0_ls_ct_ep1_set_configuration_vsequence     ls_set_ep1_config_vseq; 

    function new(string name="USB2p0_FS_isochronous_out_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
       ...
       // ls_set_ep1_config_vseq = usb2p0_ls_ct_ep1_set_configuration_vsequence::type_id::create("ls_set_ep1_config_vseq"); 	
        fs_iso_vseq = usb2p0_fs_isochronous_out_vsequence::type_id::create("fs_iso_vseq"); 	
