class USB2p0_HS_isochronous_in_test extends USB2p0_base_test;
  
   `uvm_component_utils(USB2p0_HS_isochronous_in_test)
     
    usb2p0_hs_ct_get_descriptor_vsequence            hs_get_descri_vseq;
    usb2p0_hs_ct_set_configuration_vsequence         hs_set_config_vseq; 
    usb2p0_hs_isochronous_in_vsequence                 hs_iso_vseq;

    function new(string name="USB2p0_HS_isochronous_in_test",uvm_component parent);
    ...
    function void build_phase(uvm_phase phase);
        ...
        hs_iso_vseq = usb2p0_hs_isochronous_in_vsequence::type_id::create("hs_iso_vseq"); 	
        hs_get_descri_vseq = usb2p0_hs_ct_get_descriptor_vsequence::type_id::create("hs_get_descri_vseq"); 	
    endfunction
  

   task run_phase(uvm_phase phase);
     `uvm_info("HS_ISOCHRONOUS_TRANSFER_TEST","ENTERED_USB2p0_HS_ISOCHRONOUS_IN",UVM_LOW)
     ...
     `uvm_info("HS_ISOCHRONOUS_TRANSFER_TEST","COMPLETED_USB2p0_HS_ISOCHRONOUS_IN",UVM_LOW)
  endtask
