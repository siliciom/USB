class usb2p0_ls_ct_set_configuration_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_set_configuration_vsequence)
  ...
  function new (string name = "usb2p0_ls_ct_set_configuration_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_set_configuration_vsequence::body();
