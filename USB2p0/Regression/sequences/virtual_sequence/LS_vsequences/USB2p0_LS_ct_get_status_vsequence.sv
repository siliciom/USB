class usb2p0_ls_ct_get_status_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_get_status_vsequence)
     ...
     usb2p0_host_ls_ct_get_status_sequence             get_status_seq;
 
  function new (string name = "usb2p0_ls_ct_get_status_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_get_status_vsequence::body();
     ...
     // phy_data_stage_seq=USB2p0_phy_LS_data_stage_sequence::type_id::create("phy_data_stage_seq");
      ...
      get_status_seq=usb2p0_host_ls_ct_get_status_sequence::type_id::create("get_status_seq");
