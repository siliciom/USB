class usb2p0_fs_bulk_out_error_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_bulk_out_error_vsequence)

    USB2p0_phy_FS_detect_sequence                 phy_fs_det;
    USB2p0_DEVICE_fs_setup_sequence               device_fs_det;
    usb2p0_host_fs_bulk_out_error_sequence         bulk_out_seq;

  function new (string name = "usb2p0_fs_bulk_out_error_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_bulk_out_error_vsequence::body();
    ...
    bulk_out_seq=usb2p0_host_fs_bulk_out_error_sequence::type_id::create("bulk_out_seq");
