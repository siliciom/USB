class usb2p0_ls_ct_get_configuration_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_ls_ct_get_configuration_vsequence)
   ...
   // USB2p0_DEVICE_ls_send_hs_sequence               device_handshake_send;
    ...
    usb2p0_host_ls_ct_get_configuration_sequence      get_config_seq;
   //usb2p0_host_ls_ct_set_configuration_in_sequence  set_config_seq;

  function new (string name = "usb2p0_ls_ct_get_configuration_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_ct_get_configuration_vsequence::body();
     ...
     `uvm_info("LS_CONTROL_TRANSFER_VSEQ","ENTERED_INTO_LS_CONTROL_TRANSFER_SET_CONFIGURATION_VSEQ ",UVM_LOW)
      ...
      get_config_seq=usb2p0_host_ls_ct_get_configuration_sequence::type_id::create("get_config_seq");
