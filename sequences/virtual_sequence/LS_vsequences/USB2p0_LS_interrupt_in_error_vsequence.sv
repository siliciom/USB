class usb2p0_ls_interrupt_in_error_vsequence extends usb2p0_base_virtual_sequence;
    ...
    USB2p0_DEVICE_ls_interrupt_in_error_sequence  interrupt_error;
...
task usb2p0_ls_interrupt_in_error_vsequence::body();
    ...
    interrupt_error=USB2p0_DEVICE_ls_interrupt_in_error_sequence::type_id::create("interrupt_error");
