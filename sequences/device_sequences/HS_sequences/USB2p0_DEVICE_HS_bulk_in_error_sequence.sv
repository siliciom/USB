class USB2p0_DEVICE_hs_bulk_in_error_sequence extends USB2p0_DEVICE_sequence;

  `uvm_object_utils(USB2p0_DEVICE_hs_bulk_in_error_sequence)
   USB2p0_sequence_item     req;

     function new(string name="USB2p0_DEVICE_hs_bulk_in_error_sequence");
        super.new(name);
     endfunction
 
    task body();
        `uvm_info("HS_BULK_TRANSFER_SEQ","STARTED_DEVICE_HS_BULK_TRASFER_ERROR_SEQ ",UVM_LOW)
