class USB2p0_DEVICE_controller_monitor extends uvm_monitor;
  ...
  `uvm_component_utils(USB2p0_DEVICE_controller_monitor)
    ...
    uvm_analysis_port #(USB2p0_sequence_item) device_sub_tx_mon_ap;
    uvm_analysis_port #(USB2p0_sequence_item) device_sub_rx_mon_ap;
     ...
     function void build_phase(uvm_phase phase);
       super.build_phase(phase);
         ...
         device_sub_tx_mon_ap = new("device_sub_tx_mon_ap", this);
         device_sub_rx_mon_ap = new("device_sub_rx_mon_ap", this);
   ...
   forever begin
    ...
    // tx_queue.delete();
      ...
      while ((utmi_interface_tx.utmi_txvalid || utmi_interface_tx.utmi_txvalidh)) begin
       ...
       if((!usb_device_tx_seq_item.word_if)||(usb_device_tx_seq_item.word_if)) begin
     if(usb_device_tx_seq_item.utmi_txdata.size() >= 11) begin
      usb_device_tx_seq_item.blength = usb_device_tx_seq_item.utmi_txdata[0][15:8];
      usb_device_tx_seq_item.bdescriptors_type =usb_device_tx_seq_item.utmi_txdata[1][7:0];
      usb_device_tx_seq_item.bcd_usb = {usb_device_tx_seq_item.utmi_txdata[2][7:0],usb_device_tx_seq_item.utmi_txdata[1][15:8]};
      usb_device_tx_seq_item.bDevice_class =usb_device_tx_seq_item.utmi_txdata[2][15:8];
      usb_device_tx_seq_item.bDevice_subclass =usb_device_tx_seq_item.utmi_txdata[3][7:0];
      usb_device_tx_seq_item.bDevice_protocol =usb_device_tx_seq_item.utmi_txdata[3][15:8];
      usb_device_tx_seq_item.bMax_packetsize =usb_device_tx_seq_item.utmi_txdata[4][7:0];
      usb_device_tx_seq_item.idvendor = {usb_device_tx_seq_item.utmi_txdata[5][7:0],usb_device_tx_seq_item.utmi_txdata[4][15:8]};
      usb_device_tx_seq_item.idproduct = {usb_device_tx_seq_item.utmi_txdata[6][7:0], usb_device_tx_seq_item.utmi_txdata[5][15:8]};
      usb_device_tx_seq_item.bcdDevice = {usb_device_tx_seq_item.utmi_txdata[7][7:0], usb_device_tx_seq_item.utmi_txdata[6][15:8]};
      usb_device_tx_seq_item.imanufacture =usb_device_tx_seq_item.utmi_txdata[7][15:8];
      usb_device_tx_seq_item.iproduct =usb_device_tx_seq_item.utmi_txdata[8][7:0];
      usb_device_tx_seq_item.iserial_number =usb_device_tx_seq_item.utmi_txdata[8][15:8];
      usb_device_tx_seq_item.bNum_configuration =usb_device_tx_seq_item.utmi_txdata[9][7:0];
      usb_device_tx_seq_item.bNum_configuration =usb_device_tx_seq_item.utmi_txdata[9][15:8];     
 
      `uvm_info("DEVICE_MONITOR",$sformatf("DEVICE_DESC_DECODED len=%0h desc=%0h usb=%0h vendor=%0h product=%0h",
         usb_device_tx_seq_item.blength,
         usb_device_tx_seq_item.bdescriptors_type,
         usb_device_tx_seq_item.bcd_usb,
         usb_device_tx_seq_item.idvendor,
         usb_device_tx_seq_item.idproduct,
        ),UVM_LOW)
       end
      end
	 usb_device_tx_seq_item.mon_type =USB2p0_sequence_item::DEVICE_TX;
        device_sub_tx_mon_ap.write(usb_device_tx_seq_item);
