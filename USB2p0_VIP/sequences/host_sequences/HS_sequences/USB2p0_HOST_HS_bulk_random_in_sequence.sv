...
class usb2p0_host_hs_bulk_random_in_sequence extends USB2p0_HOST_sequence;
  
	`uvm_object_utils(usb2p0_host_hs_bulk_random_in_sequence)
  	USB2p0_sequence_item req;

       function new(string name="usb2p0_host_hs_bulk_random_in_sequence");
            super.new(name);
       endfunction
