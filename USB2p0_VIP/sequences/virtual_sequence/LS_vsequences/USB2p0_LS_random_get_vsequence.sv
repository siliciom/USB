class usb2p0_ls_random_get_vsequence extends usb2p0_base_virtual_sequence;
   `uvm_object_utils(usb2p0_ls_random_get_vsequence)
    ...
    usb2p0_host_ls_get_sequence                  get_random_seq;

    bit [7:0] set_request;
  function new (string name = "usb2p0_ls_random_get_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_ls_random_get_vsequence::body();
    ...
    get_random_seq=usb2p0_host_ls_get_sequence::type_id::create("get_random_seq");
     get_random_seq.set_request = set_request;
      fork 
	get_random_seq.start(p_sequencer.host_seqr);
