class usb2p0_fs_ct_crc16_error_vsequence extends usb2p0_base_virtual_sequence;
    `uvm_object_utils(usb2p0_fs_ct_crc16_error_vsequence)
    ...
    usb2p0_host_fs_ct_crc16_error_sequence                    crc16_fs_seq;

  function new (string name = "usb2p0_fs_ct_crc16_error_vsequence");
    super.new(name);
  endfunction
...
task usb2p0_fs_ct_crc16_error_vsequence::body();
     ...
     `uvm_info("LS_CONTROL_TRANSFER_VSEQ","ENTERED_INTO_LS_CONTROL_TRANSFER_CRC5_ERROR_VSEQ ",UVM_LOW)
        ...
        crc16_fs_seq=usb2p0_host_fs_ct_crc16_error_sequence::type_id::create("crc16_fs_seq");

      fork 
	crc16_fs_seq.start(p_sequencer.host_seqr);
