...
////////////////////////////////////////////////////////////////
            ...
            `uvm_info("CRC_CHECK",$sformatf("CRC5_MATCHED ACTUAL_CRC5=%0h EXPECTED_CRC5=%0h CRC16_MATCHED ACTUAL_CRC16=%0h EXPECTED_CRC16=%0h",token_crc5,act_crc5,crc16, act_crc16),UVM_LOW)
         ...
         if(bmRequest == 8'd128 && bRequest == 8'd0 && wlength == 16'd2 && wIndex == 16'd0 && wValue == 16'd0 && token_endp == 4'd0 && token_addr == 7'd0)
            ...
            // SET_INTERFACE
              ...
              `uvm_warning("CRC_CHECK",$sformatf("CRC_MISMATCH ACTUAL_CRC5=%0h EXPECTED_CRC5=%0h ACTUAL_CRC16=%0h EXPECTED_CRC16=%0h",token_crc5,act_crc5,crc16,act_crc16))
               send_handshake_packet(PID_STALL,req);
              return;
           end
